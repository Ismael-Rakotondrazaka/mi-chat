...
const defaultValidator = (newValue) => {
  ...
  if (newValue.length > conversationConfig.MAX_DESCRIPTION_LENGTH) {
    result = `Description is too long. ${conversationConfig.MAX_DESCRIPTION_LENGTH} characters is the maximum allowed.`;
  }
