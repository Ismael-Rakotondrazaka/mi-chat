<template>
  <div class="translations-content-container">
    <div class="container">
      <div class="visible">
        <HeaderText class="text-center">Privacy Policy</HeaderText>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to mi-chat.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to mi-chat, accessible from
              <a
                href="https://mi-chat.onrender.com"
                rel="external nofollow noopener"
                target="_blank"
                >https://mi-chat.onrender.com</a
              >
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: ismaelrakotondrazaka@gmail.com</li>
        </ul>
      </div>
    </div>
  </div>
...
<script setup>
import HeaderText from "../commons/HeaderText.vue";
</script>
...
h5,
h6 {
  color: rgb(var(--color-border-primary));
}
